...
$total_cost = 0;
$user_id = get_user_id();
$base_query = "SELECT id as order_id, address, payment_method, total,user_id as 'user', created as 'order date'  ,  (select count(1) FROM OrderItems where order_id = Orders.id) as 'total_products' FROM Orders";
...
//allowed list
if (!in_array($col, ["total", "total_products", "payment_method", "address", "created","user_id"])) {
                    ...
                    <table class="table">
                        <?php foreach ($results as $index => $record) : ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="<?php echo get_url('orderdetails.php'); ?>?orderid=<?php se($record, "order_id"); ?>">Order Details</a>
                                </td>
